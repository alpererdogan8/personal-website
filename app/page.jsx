...
export default function Home() {
	return (
		<main>
			<section>
				<header className="border-b-2 border-b-[#717171] mb-[3px] ">About Me</header>
				<article className="mb-[15px] font-semibold text-[18px] dark:text-[#B8B8B8] tracking-[-1px]">
					A change-adaptive junior front-end developer with a constant desire to improve programming skills. Skilled in
					HTML, JavaScript, React.js and Cascading Style Sheets (CSS). Relating to Express.js, MongoDB(mongoose),
					Node.js in the backend.Interested in Space, Artificial Intelligence, Games too.
				</article>
			</section>
			<section>
			...
			<section>
				...
				<article>
					...
					<p className="font-semibold">
						Mail me at{' '}
						<a className="underline ml-0 pl-1 hover:text-orange-600" href="mailto:">
